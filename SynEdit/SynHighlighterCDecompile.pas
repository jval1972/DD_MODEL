...
type
  ...
  TSynCDecompileHightlighter = class(TSynCustomHighlighter)
  private
    fAsmStart: Boolean;
    fRange: TRangeState;
...
{$Q-}
function TSynCDecompileHightlighter.HashKey(Str: PWideChar): Cardinal;
begin
  Result := 0;
...
function TSynCDecompileHightlighter.IdentKind(MayBe: PWideChar): TtkTokenKind;
var
  Key: Cardinal;
begin
  fToIdent := MayBe;
...
procedure TSynCDecompileHightlighter.InitIdent;
var
  i: Integer;
begin
...
function TSynCDecompileHightlighter.AltFunc(Index: Integer): TtkTokenKind;
begin
  Result := tkIdentifier;
end;

function TSynCDecompileHightlighter.KeyWordFunc(Index: Integer): TtkTokenKind;
begin
...
function TSynCDecompileHightlighter.FuncAsm(Index: Integer): TtkTokenKind;
begin
  if IsCurrentToken(KeyWords[Index]) then
  begin
    Result := tkKey;
...
constructor TSynCDecompileHightlighter.Create(AOwner: TComponent);
begin
  ...
  fFloatAttri.Foreground := RGB(0, 0, 255);

end;


procedure TSynCDecompileHightlighter.AnsiCProc;
begin
  fTokenID := tkComment;
  case FLine[Run] of
    #0:
...
procedure TSynCDecompileHightlighter.AndSymbolProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
    '=':                               {and assign}
...
procedure TSynCDecompileHightlighter.AsciiCharProc;
begin
  fTokenID := tkChar;
  repeat
...
procedure TSynCDecompileHightlighter.AtSymbolProc;
begin
  fTokenID := tkUnknown;
  inc(Run);
end;

procedure TSynCDecompileHightlighter.BraceCloseProc;
begin
  inc(Run);
  fTokenId := tkSymbol;
...
procedure TSynCDecompileHightlighter.BraceOpenProc;
begin
  inc(Run);
  fTokenId := tkSymbol;
...
procedure TSynCDecompileHightlighter.CRProc;
begin
  fTokenID := tkSpace;
  Inc(Run);
...
procedure TSynCDecompileHightlighter.ColonProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
...
procedure TSynCDecompileHightlighter.CommaProc;
begin
  inc(Run);
  fTokenID := tkSymbol;
...
procedure TSynCDecompileHightlighter.DirectiveProc;
begin
...
procedure TSynCDecompileHightlighter.DirectiveEndProc;
begin
  fTokenID := tkDirective;
  case FLine[Run] of
    #0:
...
procedure TSynCDecompileHightlighter.EqualProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
    '=':                               {logical equal}
...
procedure TSynCDecompileHightlighter.GreaterProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
...
procedure TSynCDecompileHightlighter.QuestionProc;
begin
...
procedure TSynCDecompileHightlighter.IdentProc;
begin
...
procedure TSynCDecompileHightlighter.LFProc;
begin
  fTokenID := tkSpace;
  inc(Run);
end;

procedure TSynCDecompileHightlighter.LowerProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
...
procedure TSynCDecompileHightlighter.MinusProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
    '=':                               {subtract assign}
...
procedure TSynCDecompileHightlighter.ModSymbolProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
    '=':                               {mod assign}
...
procedure TSynCDecompileHightlighter.NotSymbolProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
    '=':                               {not equal}
...
procedure TSynCDecompileHightlighter.NullProc;
begin
  fTokenID := tkNull;
  inc(Run);
end;

procedure TSynCDecompileHightlighter.NumberProc;
...
procedure TSynCDecompileHightlighter.PlusProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
    '=':                               {add assign}
...
procedure TSynCDecompileHightlighter.PointProc;
begin
  fTokenID := tkSymbol;
...
procedure TSynCDecompileHightlighter.RoundCloseProc;
begin
  inc(Run);
  fTokenID := tkSymbol;
...
procedure TSynCDecompileHightlighter.RoundOpenProc;
begin
  inc(Run);
  FTokenID := tkSymbol;
...
procedure TSynCDecompileHightlighter.SemiColonProc;
begin
  inc(Run);
  fTokenID := tkSymbol;
...
procedure TSynCDecompileHightlighter.SlashProc;
begin
  case FLine[Run + 1] of
    '/':                               {c++ style comments}
      begin
...
procedure TSynCDecompileHightlighter.SpaceProc;
begin
  inc(Run);
  fTokenID := tkSpace;
...
procedure TSynCDecompileHightlighter.SquareCloseProc;
begin
  inc(Run);
  fTokenID := tkSymbol;
...
procedure TSynCDecompileHightlighter.SquareOpenProc;
begin
  inc(Run);
  fTokenID := tkSymbol;
...
procedure TSynCDecompileHightlighter.StarProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
    '=':                               {multiply assign}
...
procedure TSynCDecompileHightlighter.StringProc;
begin
  fTokenID := tkString;
  repeat
    if fLine[Run] = '\' then begin
...
procedure TSynCDecompileHightlighter.StringEndProc;
begin
  fTokenID := tkString;
...
procedure TSynCDecompileHightlighter.TildeProc;
begin
...
procedure TSynCDecompileHightlighter.XOrSymbolProc;
begin
  fTokenID := tkSymbol;
  case FLine[Run + 1] of
  	'=':                               {xor assign}
...
procedure TSynCDecompileHightlighter.UnknownProc;
begin
  Inc(Run);
  fTokenID := tkUnknown;
end;

procedure TSynCDecompileHightlighter.Next;
begin
  fAsmStart := False;
  fTokenPos := Run;
  case fRange of
...
function TSynCDecompileHightlighter.GetDefaultAttribute(Index: integer): TSynHighlighterAttributes;
begin
  case Index of
...
function TSynCDecompileHightlighter.GetEol: Boolean;
begin
  Result := Run = fLineLen + 1;
end;

function TSynCDecompileHightlighter.GetRange: Pointer;
begin
  Result := Pointer(fRange);
end;

function TSynCDecompileHightlighter.GetTokenID: TtkTokenKind;
begin
  Result := fTokenId;
...
function TSynCDecompileHightlighter.GetExtTokenID: TxtkTokenKind;
begin
  Result := FExtTokenID;
end;

function TSynCDecompileHightlighter.GetTokenAttribute: TSynHighlighterAttributes;
begin
  fTokenID := GetTokenID;
  case fTokenID of
...
function TSynCDecompileHightlighter.GetTokenKind: integer;
begin
  Result := Ord(GetTokenID);
end;

procedure TSynCDecompileHightlighter.ResetRange;
begin
  fRange:= rsUnknown;
end;

procedure TSynCDecompileHightlighter.SetRange(Value: Pointer);
begin
  fRange := TRangeState(Value);
end;

procedure TSynCDecompileHightlighter.EnumUserSettings(settings: TStrings);
begin
...
function TSynCDecompileHightlighter.UseUserSettings(settingIndex: integer): boolean;
...
begin
  ...
  Result := False;
  {$ENDIF}
end; { TSynCDecompileHightlighter.UseUserSettings }

function TSynCDecompileHightlighter.IsFilterStored: Boolean;
begin
  Result := fDefaultFilter <> SYNS_FilterCPP;
end;

class function TSynCDecompileHightlighter.GetLanguageName: string;
begin
  Result := SYNS_LangCPP;
end;

class function TSynCDecompileHightlighter.GetCapabilities: TSynHighlighterCapabilities;
begin
  Result := inherited GetCapabilities + [hcUserSettings];
end;

function TSynCDecompileHightlighter.GetSampleSource: UnicodeString;
begin
...
class function TSynCDecompileHightlighter.GetFriendlyLanguageName: UnicodeString;
begin
...
initialization
{$IFNDEF SYN_CPPB_1}
  RegisterPlaceableHighlighter(TSynCDecompileHightlighter);
{$ENDIF}
end.
