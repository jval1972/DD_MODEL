...
unit SynHighlighterDDDecompile;
{$ENDIF}
...
type
  TSynDDDecompileHightlighter = class(TSynCustomHighlighter)
  private
...
function TSynDDDecompileHightlighter.IsIdentChar(AChar: WideChar): Boolean;
var
  i: Integer;
begin
  Result := False;
...
function TSynDDDecompileHightlighter.IsKeyword(const AKeyword: UnicodeString): Boolean;
var
...
function TSynDDDecompileHightlighter.IsWordBreakChar(AChar: WideChar): Boolean;
begin
  Result := inherited IsWordBreakChar(AChar) and not IsIdentChar(AChar);
end;

constructor TSynDDDecompileHightlighter.Create(AOwner: TComponent);
begin
...
destructor TSynDDDecompileHightlighter.Destroy;
begin
  fKeyWords.Free;
  inherited Destroy;
end; { Destroy }

procedure TSynDDDecompileHightlighter.AnsiProc;
begin
  case fLine[Run] of
     #0: NullProc;
    #10: LFProc;
...
procedure TSynDDDecompileHightlighter.PasStyleProc;
begin
  case fLine[Run] of
     #0: NullProc;
    #10: LFProc;
...
procedure TSynDDDecompileHightlighter.CStyleProc;
begin
  case fLine[Run] of
     #0: NullProc;
    #10: LFProc;
...
procedure TSynDDDecompileHightlighter.AsciiCharProc;
begin
...
procedure TSynDDDecompileHightlighter.BraceOpenProc;
begin
  fTokenID := tkComment;
  fRange := rsPasStyle;
  inc(Run);
...
procedure TSynDDDecompileHightlighter.PointCommaProc;
begin
  inc(Run);
  fTokenID := tkSymbol;
end;

procedure TSynDDDecompileHightlighter.CRProc;
begin
  fTokenID := tkSpace;
  Inc(Run);
...
procedure TSynDDDecompileHightlighter.IdentProc;
begin
...
procedure TSynDDDecompileHightlighter.IntegerProc;
...
procedure TSynDDDecompileHightlighter.LFProc;
begin
  fTokenID := tkSpace;
  inc(Run);
end;

procedure TSynDDDecompileHightlighter.NullProc;
begin
  fTokenID := tkNull;
  inc(Run);
end;

procedure TSynDDDecompileHightlighter.NumberProc;
...
procedure TSynDDDecompileHightlighter.RoundOpenProc;
begin
  inc(Run);
  fTokenId := tkSymbol;
end;

procedure TSynDDDecompileHightlighter.SlashProc;
begin
  Inc(Run);
  if FLine[Run] = '/' then
  begin
...
procedure TSynDDDecompileHightlighter.SpaceProc;
begin
  inc(Run);
  fTokenID := tkSpace;
...
procedure TSynDDDecompileHightlighter.StringProc;
var
   delim : WideChar;
begin
  fTokenID := tkString;
...
procedure TSynDDDecompileHightlighter.UnknownProc;
begin
  inc(Run);
  fTokenID := tkUnknown;
end;

procedure TSynDDDecompileHightlighter.Next;
begin
  fTokenPos := Run;
  case fRange of
    rsAnsi: AnsiProc;
...
function TSynDDDecompileHightlighter.GetDefaultAttribute(Index: integer): TSynHighlighterAttributes;
begin
  case Index of
...
function TSynDDDecompileHightlighter.GetEol: Boolean;
begin
  Result := Run = fLineLen + 1;
end;

function TSynDDDecompileHightlighter.GetRange: Pointer;
begin
  Result := Pointer(fRange);
end;

function TSynDDDecompileHightlighter.GetTokenID: TtkTokenKind;
begin
  Result := fTokenId;
end;
...
// GetCharBeforeToken
//
function TSynDDDecompileHightlighter.GetCharBeforeToken(offset : Integer = -1) : WideChar;
begin
...
// GetCharAfterToken
//
function TSynDDDecompileHightlighter.GetCharAfterToken(offset : Integer = 1) : WideChar;
begin
   Result := FLine[fTokenPos+offset];
end;

function TSynDDDecompileHightlighter.GetTokenAttribute: TSynHighlighterAttributes;
begin
  case fTokenID of
...
function TSynDDDecompileHightlighter.GetTokenKind: integer;
begin
  Result := Ord(fTokenId);
end;

procedure TSynDDDecompileHightlighter.ResetRange;
begin
  fRange := rsUnknown;
end;

procedure TSynDDDecompileHightlighter.SetRange(Value: Pointer);
begin
  fRange := TRangeState(Value);
end;

procedure TSynDDDecompileHightlighter.SetKeyWords(const Value: TUnicodeStrings);
var
  i: Integer;
begin
  if Value <> nil then
...
class function TSynDDDecompileHightlighter.GetLanguageName: string;
begin
  Result := 'DDDecompile';
end;

{$IFNDEF SYN_CLX}
function TSynDDDecompileHightlighter.LoadFromRegistry(RootKey: HKEY; Key: string): boolean;
var
  r: TBetterRegistry;
begin
...
function TSynDDDecompileHightlighter.SaveToRegistry(RootKey: HKEY; Key: string): boolean;
var
  r: TBetterRegistry;
begin
  r := TBetterRegistry.Create;
...
function TSynDDDecompileHightlighter.GetStringDelim: TStringDelim;
begin
  Result := fStringDelim;
end;

procedure TSynDDDecompileHightlighter.SetStringDelim(const Value: TStringDelim);
begin
   fStringDelim := Value;
end;

function TSynDDDecompileHightlighter.GetIdentifierChars: UnicodeString;
begin
  Result := fIdentChars;
end;

procedure TSynDDDecompileHightlighter.SetIdentifierChars(const Value: UnicodeString);
begin
  fIdentChars := Value;
end;

function TSynDDDecompileHightlighter.StoreIdentChars: Boolean;
begin
   Result := (fIdentChars <> cDefaultIdentChars);
end;

procedure TSynDDDecompileHightlighter.SetDetectPreprocessor(Value: boolean);
begin
...
class function TSynDDDecompileHightlighter.GetFriendlyLanguageName: UnicodeString;
begin
  Result := 'Pascal Decompile';
end;

// IsStringDelim
//
function TSynDDDecompileHightlighter.IsStringDelim(aChar : WideChar) : Boolean;
begin
...
initialization
{$IFNDEF SYN_CPPB_1}
  RegisterPlaceableHighlighter(TSynDDDecompileHightlighter);
{$ENDIF}
end.
